    ...
    def _handle_app_home_opened(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                log.info(f"Published app home view for user {user_id}")
                return {"status": "ok", "message": "App home view published"}
                
            except SlackApiError as e:
                log.error(f"Failed to publish app home view: {e}")
                return {"status": "error", "message": f"Failed to publish view: {str(e)}"}
            
        except SlackApiError as e:
            log.error(f"Slack API error in app_home_opened: {e}")
