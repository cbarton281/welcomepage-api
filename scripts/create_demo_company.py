...
def create_bento_widgets(user_index: int, location: str, photo_v2_url: str = "", photo_v2_caption: str = "", spotify_url: str = "", spotify_image_url: str = "", spotify_data: dict = None, youtube_url: str = "", video_thumbnail_url: str = "", video_caption: str = "") -> List[Dict[str, Any]]:
    ...
    for i, widget_type in enumerate(BENTO_WIDGET_TYPES):
        ...
        if widget_type['id'] == 'location':
            ...
            all_activities = [
                {"emoji": "🏔️", "caption": "hiking and exploring nature"},
                {"emoji": "🎲", "caption": "playing board games with friends"},
                {"emoji": "🍳", "caption": "cooking new recipes"},
                {"emoji": "📚", "caption": "reading science fiction novels"},
                {"emoji": "📸", "caption": "photography and editing"},
                {"emoji": "🎨", "caption": "painting and drawing"},
                {"emoji": "🎵", "caption": "playing musical instruments"},
                {"emoji": "🏃", "caption": "running and jogging"},
                {"emoji": "🧘", "caption": "yoga and meditation"},
                {"emoji": "🌱", "caption": "gardening"},
                {"emoji": "✈️", "caption": "traveling to new places"},
                {"emoji": "🎮", "caption": "gaming"},
                {"emoji": "🏋️", "caption": "weightlifting"},
                {"emoji": "🎬", "caption": "watching movies"},
                {"emoji": "🍕", "caption": "trying new restaurants"},
            ]
...
async def main_async():
    ...
    try:
        ...
        print("  ✓ Wave GIFs: Downloaded from test_wave_gif_library and uploaded to user storage")
        print("  ✓ Bento widget images: Photo-v2 images downloaded and uploaded with pet-specific captions")
        print("  ✓ Spotify URLs: Sample playlists, tracks, and shows assigned to each user")
        print("  ✓ YouTube URLs: Sample videos assigned to each user with video ID extraction")
        print("="*60)
